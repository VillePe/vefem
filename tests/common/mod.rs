...
use idfem::{loads::Load, material::Steel, structure::{element::MaterialType, Element, Node, Profile}};
use vputilslib::geometry2d::VpPoint;

pub fn get_fem_matriisit_releases_structure() -> (Vec<Element>, HashMap<i32, Node>) {
    ...
    nodes.insert(3, Node::new_fixed(3, VpPoint::new(nodes[&1].point.x + 6000.0, 0.0))); // 6000, 0
    nodes.insert(4, Node::new_free(4, VpPoint::new(nodes[&3].point.x, nodes[&2].point.y))); // 6000, 4000
...
pub fn get_fem_matriisit_releases_loads() -> Vec<Load> {
